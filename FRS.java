...
public class customer{
	...
	Scanner s = new Scanner(System.in);
		...
		System.out.println("Your luggage_count : ");
		luggage_count = s.next();
	}
}
...
public class book_flight{
	...
	static void removepassensger()
	{
		string email;
		system.out.println("Enter Your Email to verify identity :");
		email = s.next();
	}
	static getprice()
	{
		system.out.println("Your Final Reservation Price :");
		bookAisle();
	}
}
...
public class booking {
	...
	public static void main(String args[]) {
		System.out.println("Welcome to the DIC lovin flight reservation system!");
		System.out.println();
